...
import { StatsCard, ResultsTable, LoadingState } from "@/components/results";
    ...
    <main className="min-h-screen flex flex-col">
      ...
      <section className="flex-1 py-8">
        <div className="container mx-auto px-4">
            ...
            <>
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground">
                  <span>
                    {data.pagination.totalResults} resultado(s) encontrado(s)
                  </span>
                  <span className="text-muted-foreground/50">|</span>
                  <span>
                    Fontes: {data.meta.sources.join(", ")}
                  </span>
                  {data.meta.cached && (
                    <>
                      <span className="text-muted-foreground/50">|</span>
          ...
          {term && !isLoading && !error && data && data.results.length === 0 && (
            <div className="text-center py-16 bg-slate-50 rounded-lg">
              <p className="text-muted-foreground font-medium">
                Nenhum resultado encontrado para &quot;{term}&quot;
              </p>
              <p className="text-sm text-muted-foreground mt-2">
                Tente pesquisar com outros termos, por exemplo: papel, caneta, computador
              </p>
            </div>
          )}
        </div>
